...
struct StorageInfo const StorageInfo = {
	.DeviceName         = "24C64_STM32F105RB-I2C1-R",      // Device Name + version number
	.DeviceType         = I2C_EEPROM,                 // Device Type
	.DeviceStartAddress = 0x00000000,                 // Device Start Address
	.DeviceSize         = CONFIG_EEPROM_SIZE,         // Device Size in Bytes (8 kBytes / 64 kBits)
	.PageSize           = CONFIG_EEPROM_PAGE_SIZE,    // Programming Page Size 32 Bytes
